    ...
    public void Guardar(View view){
        ...
        if(nuevo.datosOpcionales(texto1,35)){
            if(nuevo.datosOpcionales(texto2,35)){
                ...
                //disminui 15
                calendar.set(Calendar.MINUTE,min(hora)-15);
                ...
                edit.putString("nomCita", nom_Cita);
                edit.putString("horascita", hora);
                edit.putString("fechacita", date);
                edit.putString("direccion", des);
                edit.putString("descripcion", dir);
                edit.putString("tipo", "2");
                edit.putLong("tiempo", calendar.getTimeInMillis());
